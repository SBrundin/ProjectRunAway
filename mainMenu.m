...
% Last Modified by GUIDE v2.5 17-Apr-2019 10:21:15
...
% --- Executes on button press in Historik.
function Historik_Callback(hObject, eventdata, handles)
% hObject    handle to Historik (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
search;
load('userstruct.mat')
